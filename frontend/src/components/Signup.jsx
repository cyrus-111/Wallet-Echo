...
const Signup = ({ API_URL = "http://localhost:4000", onSignup }) => {
    ...
    // to validate that all fields are filled by the user
            ...
            <div className={signupStyles.cardContainer}>
                <div className={signupStyles.header}>
                    ...
                    <p className={signupStyles.headerSubtitle}>
                        Join Wallet-Echo to manage your finances
                    </p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} noValidate>
                        <div className="mb-6">
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type="text" id="name" value={name} onChange={(e) => setName(e.target.value)} className={`${signupStyles.input} ${errors.name ? "border-red-300" : "border - gray - 200" }`}
                        ...
                        <div className="mb-6">
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type="email" id="email" value={email} onChange={(e) => setEmail(e.target.value)} className={`${signupStyles.input} ${errors.email ? "border-red-300" : "border - gray - 200"}`}
                        ...
                        <div className="mb-6">
                            ...
                            <div className={signupStyles.inputContainer}>
                                ...
                                <input type={showPassword ? "text" : "password"} id="password" value={password} onChange={(e) => setPassword(e.target.value)} className={`${signupStyles.passwordInput} ${errors.password ? "border-red-300" : "border - gray - 200"}`}
                                    placeholder="●●●●●●"
                                />
                        ...
                        <div className={signupStyles.checkboxContainer}>
                            <input type="checkbox" id="remember" checked={rememberMe} onChange={(e) => setRememberMe(e.target.checked)} className={signupStyles.checkbox}
                            />
