        ...
        <header className={navbarStyles.header}>
            <div className={navbarStyles.container}>
                ...
                <div onClick={() => navigate("/")} className={navbarStyles.logoContainer}>
                    ...
                    <span className={navbarStyles.logoText}>Wallet Echo</span>
                </div>
                    ...
                    <div className={navbarStyles.userContainer} ref={menuRef} >
                        <button onClick={toggleMenu} className={navbarStyles.userButton}>
                            ...
                            <div className={navbarStyles.userTextContainer}>
                                ...
                                <p className={navbarStyles.userEmail}>{user?.email || "user@walletecho.com"} </p>
                            </div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className={navbarStyles.dropdownEmail}>
                                                {user?.email || "user@walletecho.com"}
                                            </div>
                                        </div>
