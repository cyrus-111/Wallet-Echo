...
const Dashboard = () => {
  ...
  const [showAllIncome, setShowAllIncome] = useState(false); // this is to toggle
  ...
  // function to check if a date is in raneg
  ...
  //update the gauge when the time frame changes
  useEffect(() => {
    const maxValues = {
  ...
  }, [currentTimeFrameData, timeFrame]); // the graph will be according to this data
