...
// to scroll to top when page gets refreshed or reload or new page is visited
...
const App = () => {
  ...
  // to update the user data noth in state and storage
  ...
  // try to load user with token when mountedd
  ...
  useEffect(() => {
    try {
      ...
      console.error("Error saving the transactions:", err);
    }
  }, [transactions]);
    ...
    <>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute user={user}><Layout user={user} onLogout={handleLogout}
          ...
          addTransaction={addTransaction} editTransaction={editTransaction} deleteTransaction={deleteTransaction} refreshTransactions={refreshTransactions} /></ProtectedRoute>}>
